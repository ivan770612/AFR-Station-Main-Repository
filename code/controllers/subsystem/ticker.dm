...
/datum/controller/subsystem/ticker/Shutdown()
	...
	if(!round_end_sound)
		...
		'sound/roundend/beblasting.ogg',
		'sound/roundend/boys.ogg',
		'sound/roundend/creizy.ogg',
		'sound/roundend/foolblasting.ogg',
		'sound/roundend/laugh.ogg',
		'sound/roundend/lethalfools.ogg',
		'sound/roundend/payment.ogg',
		'sound/roundend/rabi.ogg',
		'sound/roundend/urakolouy.ogg'\
		)
